...
::: callout-note
Note: Contents of this page are referenced from instructor's materials: [3 Programming Interactive Data Visualisation with R](https://r4va.netlify.app/chap03) and [4 Programming Animated Statistical Graphics with R](https://r4va.netlify.app/chap04)
:::
...
[ggiraph](https://davidgohel.github.io/ggiraph/index.html) ![](img/image1.jpg){width="50"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
...
If it used within a shiny application, elements associated with an id (data_id) can be selected and manipulated on client and server sides. Refer to this [article](https://davidgohel.github.io/ggiraph/articles/offcran/shiny.html) for more detailed explanation.
...
In this section, *GlobalPopulation.xls* provided will be used. Using [*read_xls()*](https://readxl.tidyverse.org/reference/read_excel.html) of **readxl** package, import *GlobalPopulation.xls* into R. ::: {style="font-size: 1.2em"}
